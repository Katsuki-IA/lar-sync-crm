drop function if exists public.crm_process_next_prospeccao_leads(bigint, integer, boolean);
...
revoke all on function public.crm_process_next_prospeccao_leads(bigint, integer)
from public, anon, authenticated;

grant execute on function public.crm_process_next_prospeccao_leads(bigint, integer)
to service_role;
...
where lead.id::text = queue.id_lead
  ...
  and queue.last_error = 'Prospecção pausada até aprovação do fluxo';
